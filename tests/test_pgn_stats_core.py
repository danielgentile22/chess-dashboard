...
class TestReviewQueue:
    ...
    def test_opponent_lessons_outrank_generic_recent_ones(self):
        ...
        games = [
            {"lessons": ["From facing Edwards"], "opponent": "Edwards"},
            {"lessons": ["From facing someone else"], "opponent": "Lopez"},
            {"lessons": ["Newest, also someone else"], "opponent": "Lopez"},
        ]
        queue = review_queue(_games_with_lessons(games), opponent="Edwards")
        assert queue[0]["Lesson"] == "From facing Edwards"
        assert queue[0]["reason"] == "You're facing Edwards"
    ...
    def test_weakness_outranks_opponent(self):
        ...
        games = [
            {"lessons": ["Opponent lesson"], "opponent": "Edwards"},
