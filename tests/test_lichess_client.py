...
[ChapterURL "https://lichess.org/study/6jYtXHGp/aaaaaaaa"]
...
[ChapterURL "https://lichess.org/study/6jYtXHGp/bbbbbbbb"]
...
class TestFetchStudyPgn:
    ...
    def test_token_sent_as_bearer_auth_header(self):
        with mock.patch("lichess_client.requests.get", return_value=_response()) as get:
            fetch_study_pgn("6jYtXHGp", token="lip_secret123")
