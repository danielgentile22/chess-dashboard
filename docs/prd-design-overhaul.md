...
- Verification beyond unit tests: run the app against the real Study (`6jYtXHGp`) and re-screenshot all pages at both widths; specifically confirm the four bugs above are gone.
