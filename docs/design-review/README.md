...
against the real Study (`6jYtXHGp`, member `32487228`), at both widths:

| File | Surface | Shows |
| --- | --- | --- |
| `before-events-1440.png` / `before-events-390.png` | Events | A Series group expanded (ACC Friday Ladder) with one crosstable open |
| `before-scouting-1440.png` / `before-scouting-390.png` | Scouting Report | An opponent (Edward A. Cadogan) with the USCF identity block — official-page link + then-vs-now ratings |
